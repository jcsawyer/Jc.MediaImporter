...
public class Files
{
    ...
    internal static void TraverseTreeParallelForEach(ICollection<string> paths, Action<string> fileAction)
    {
        //Count of files traversed and timer for diagnostic output
        int fileCount = 0;
        var sw = Stopwatch.StartNew();
    ...
    internal static void TraverseTreeParallelForEach(string root,
        Func<string, (bool SkipFiles, int FileCount)> folderAction, Action<string> fileAction, ref int fileCount,
        ref int dirCount)
    {
        //Count of files traversed and timer for diagnostic output
        var sw = Stopwatch.StartNew();
